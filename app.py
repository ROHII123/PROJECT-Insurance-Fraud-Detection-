...
load_model= pickle.load(open("C:/Users/Nitin_Kondaval/Downloads/New folder/Project_Fraud_detection pickle file.py",'rb'))
...
def main():
    ...
    Days_spend_hsptl=st.text_input("Days_spend_hsptl")
    Admission_type=st.text_input("Admission_type")
    Home_or_self_care=st.text_input("Home_or_self_care")
    ccs_diagnosis_code=st.text_input("ccs_diagnosis_code")
    ...
    Surg_Description=st.text_input("Surg_Description")
    Weight_baby=st.text_input("Weight_baby")
    Abortion=st.text_input("Abortion")
    Emergency_dept=st.text_input("Emergency dept")
    Tot_charg=st.text_input("Tot_charge")
    Payment_Typology=st.text_input("Payment_Typology")
